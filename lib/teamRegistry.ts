...
export const ALL_TEAMS: RegistryTeam[] = [
  ...
  // ── NPB ──────────────────────────────────────────────────────────────
  { abbreviation: 'G',  name: 'Yomiuri Giants',         primaryColor: '#F15A22', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'T',  name: 'Hanshin Tigers',         primaryColor: '#FFE200', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'DB', name: 'DeNA BayStars',          primaryColor: '#003087', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'C',  name: 'Hiroshima Carp',         primaryColor: '#C8102E', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'D',  name: 'Chunichi Dragons',       primaryColor: '#003A78', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'S',  name: 'Tokyo Yakult Swallows',  primaryColor: '#004098', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'Bs', name: 'Orix Buffaloes',         primaryColor: '#00356D', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'H',  name: 'SoftBank Hawks',         primaryColor: '#FCC40D', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'E',  name: 'Rakuten Eagles',         primaryColor: '#9E1B32', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'L',  name: 'Seibu Lions',            primaryColor: '#00578A', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'M',  name: 'Lotte Marines',          primaryColor: '#000000', leagueId: 2, leagueName: 'NPB' },
  { abbreviation: 'F',  name: 'Nippon-Ham Fighters',    primaryColor: '#0C1C5F', leagueId: 2, leagueName: 'NPB' },

  // ── KBO ──────────────────────────────────────────────────────────────
  { abbreviation: 'LG',  name: 'LG Twins',       primaryColor: '#C30452', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'OB',  name: 'Doosan Bears',   primaryColor: '#131230', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'KIA', name: 'KIA Tigers',     primaryColor: '#EA0029', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'SS',  name: 'Samsung Lions',  primaryColor: '#074CA1', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'HH',  name: 'Hanwha Eagles',  primaryColor: '#FF6600', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'SSG', name: 'SSG Landers',    primaryColor: '#CE0E2D', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'LT',  name: 'Lotte Giants',   primaryColor: '#041E42', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'KW',  name: 'Kiwoom Heroes',  primaryColor: '#820024', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'KT',  name: 'KT Wiz',         primaryColor: '#000000', leagueId: 3, leagueName: 'KBO' },
  { abbreviation: 'NC',  name: 'NC Dinos',        primaryColor: '#315288', leagueId: 3, leagueName: 'KBO' },
];
